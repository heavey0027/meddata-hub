...
| `stats.py`   | `/api/statistics/monthly`          | `GET`    | 按月份统计当月患者档案数与就诊人次，并计算较上月的增长率 |
...
| `stats.py` | `/api/stats/disease_drug_association` | `GET` | 查找针对特定疾病最常使用的药物。                         |
| `stats.py` | `/api/stats/medicine_association`     | `GET` | 发现药品之间的关联规则，例如“买了药A 的人通常也会买药 B” |
